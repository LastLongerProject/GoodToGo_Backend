...
userSchema.methods.generateNotice = function () {
    let formattedExtraNotice = this.extraNotice !== null ? this.extraNotice + "\n" : "";
    if (templateKeyValidater.test(formattedExtraNotice) && extraNoticeTemplate[formattedExtraNotice]) {
        formattedExtraNotice = extraNoticeTemplate[formattedExtraNotice];
    }
