    ...
    production: function () {
        ...
        setTimeout(function noneTimeSensitiveTask() {
            let taskList = function () {
                ...
                setTimeout(tasks.containerListInit, 0, generalCb);
                setTimeout(tasks.couponListInit, 1000 * 60 * 3, generalCb);
                setTimeout(tasks.storeListInit, 1000 * 60 * 5, generalCb);
                setTimeout(function () {
        ...
        getSystemBot((err, dbBot) => {
            ...
            setTimeout(function taskToDoAtTenInTheMorning() {
                let taskList = function taskList() {
                    ...
                    setTimeout(tasks.refreshAllUserUsingStatus, 0, true, generalCb);
                };
                taskList();
                setInterval(taskList, MILLISECONDS_OF_A_DAY);
