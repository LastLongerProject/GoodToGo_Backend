...
module.exports={
    ...
    List_Of_Summary_For_Store:function(dataset,startTime){
        return new Promise(function(resolve,reject){
            ...
            while(date<new Date('2019-12-23')){
                Date_Location_In_datalist[date.toLocaleDateString('roc',{year: 'numeric', month: '2-digit', day: '2-digit'})]=data_list.length;
                data_list.push([date.toLocaleDateString('roc',{year: 'numeric', month: '2-digit', day: '2-digit'}),0,0,0,0,null,0,0,null,0,null,0,null,0])
            ...
            dataset.Rent_Trades.forEach(trade=>{
                ...
                tradeTime=new Date(tradeTime).toLocaleDateString('roc',{year: 'numeric', month: '2-digit', day: '2-digit'})
    ...
    List_Of_Rent_UnLogRent_Return_For_Store:function(storeID,dataset,startTime){
        return new Promise(function(resolve,reject){
            ...
            while(date<new Date('2019-12-23')){
                Date_Location_In_datalist[date.toLocaleDateString('roc',{year: 'numeric', month: '2-digit', day: '2-digit'})]=data_list.length;
                data_list.push([date.toLocaleDateString('roc',{year: 'numeric', month: '2-digit', day: '2-digit'})])
                date=new Date((date-1)+1+7*day);
            }
            ...
            storeDB.find({
                ...
                Zero_Padding(data_list).then(data_list=>{
                    ...
                    dataset.forEach(data=>{
                        ...
                        TimeStamp=new Date(TimeStamp).toLocaleDateString('roc',{year: 'numeric', month: '2-digit', day: '2-digit'});
                        if(data[1]==='Rent'){
