define({ "api": [
  ...
  },
  {
    ...
    "description": "<p><strong>available state changing list</strong>: - Boxing -&gt; Stocked - Boxing -&gt; Delivering - Delivering -&gt; Boxing - Signed -&gt; Stocked - Stocked -&gt; Boxing</p>",
    "parameter": {
      "examples": [
        {
          "title": "Request-Example:",
  ...
  {
    "name": "DeliveryList_delete_box_info",
    "group": "DeliveryList",
    "type": "delete",
    "url": "/deliveryList/deleteBox/:boxID",
    "title": "Delete box info",
    "permission": [
      {
        "name": "admin",
        "title": "Admin access rights needed.",
    ...
    "description": "<p>@apiSuccessExample {json} Success-Response: HTTP/1.1 200 { type: &quot;DeleteMessage&quot;, message: &quot;Delete successfully&quot; }</p>",
    "version": "0.0.0",
    "filename": "routes/deliveryList.js",
    "groupTitle": "DeliveryList",
    "header": {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "lineId",
            "description": "<p>lineId of the User.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
